(function ($) {
  ...
  // Date Picker
  if ($(".mediox-datepicker").length) {
    $(".mediox-datepicker").each(function () {
      $(this).datepicker({
        minDate: 0,        // today
        maxDate: 15        // 15 days from today
      });
    });
  }
  ...
  //accordion
  if ($(".mediox-accordion").length) {
    var accordionGrp = $(".mediox-accordion");
        ...
        $(this)
          ...
          .on("click", function () {
            if ($(this).parent().hasClass("active") === false) {
              $(".mediox-accordion." + accordionName)
                .find(".accordion")
                .removeClass("active");
              $(".mediox-accordion." + accordionName)
                .find(".accordion")
  ...
  function medioxSlickInit() {
    // slick slider
    let medioxslickCarousel = $(".mediox-slick__carousel");
    if (medioxslickCarousel.length) {
      medioxslickCarousel.each(function () {
        let elm = $(this);
        let options = elm.data("slick-options");
        let medioxslickCarousel = elm.slick(
          "object" === typeof options ? options : JSON.parse(options)
        );
      });
    }
  ...
  function mediox_stretch() {
    var i = $(window).width();
    $(".row .mediox-stretch-element-inside-column").each(function () {
      var $this = $(this),
