<?php $head_title = "Blog Carousel || Mediox || Medical & Healthcare PHP Template" ?>
...
<?php require_once('parts/header/header-four.php'); ?>
        ...
        <section class="blog-page section-space">
            <div class="container">
                <div class="blog-page__carousel mediox-owl__carousel mediox-owl__carousel--basic-nav owl-carousel owl-theme" data-owl-options='{
                  "items": 1,
                  "margin": 10,
                  "loop": true,
                  "smartSpeed": 700,
                  ...
                  "responsive": {
                    ...
                    <div class="item">
                        <div class="blog-card-two wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='800ms'>
                            <div class="blog-card-two__image">
                                <img src="assets/images/blog/blog-2-9.jpg" alt="circle back, if you want to motivate these clowns">
                                <a href="blog-details-right.php" class="blog-card-two__hover">
                            ...
                            <div class="blog-card-two__content">
                                <h3 class="blog-card-two__title"><a href="blog-details-right.php">circle back, if you want to motivate these clowns</a></h3><!-- /.blog-card-two__title -->
                                <ul class="list-unstyled blog-card-two__meta">
                                    <li>
                                        <a href="#">
                                            <span class="blog-card-two__meta__icon">
