<?php $head_title = "Products Left Sidebar || Mediox || Medical & Healthcare PHP Template" ?>
...
<?php require_once('parts/header/header-four.php'); ?>
                ...
                <div class="page-header__inner">
                    ...
                    <div class="container">
                        <div class="page-header__content">
                            <h2 class="page-header__title">products left sidebar</h2>
                        ...
                        <aside class="product__sidebar">
                            ...
                            <div class="product__categories product__sidebar__item">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="products-right.php"><span class="product-categories__icon"><i class="icon-arrow-point-to-right"></i></span>
                                            <!-- /.product-categories__icon --> health care</a></li>
                                    <li><a href="products-right.php"><span class="product-categories__icon"><i class="icon-arrow-point-to-right"></i></span>
                                            <!-- /.product-categories__icon --> medical service</a></li>
                                    <li><a href="products-right.php"><span class="product-categories__icon"><i class="icon-arrow-point-to-right"></i></span>
                                            <!-- /.product-categories__icon --> neurology</a></li>
                                    <li><a href="products-right.php"><span class="product-categories__icon"><i class="icon-arrow-point-to-right"></i></span>
                                            <!-- /.product-categories__icon --> successful surgery</a></li>
                                    <li><a href="products-right.php"><span class="product-categories__icon"><i class="icon-arrow-point-to-right"></i></span>
                                            <!-- /.product-categories__icon --> mediox care</a></li>
                                </ul>
                            </div><!-- /.category-widget -->
                        </aside><!-- /.shop-sidebar -->
                        ...
                        <div class="row gutter-y-30">
                            <div class="col-xl-4 col-sm-6">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                                    <div class="product__item__image">
                                        <img src="assets/images/products/product-1-1.jpg" alt="Shelcal 500">
                                    </div><!-- /.product-image -->
                                    <div class="product__item__content">
                                        ...
                                        <h4 class="product__item__title"><a href="product-details.php">Shelcal 500</a></h4><!-- /.product-title -->
                                        <div class="product__item__price">$82.00</div><!-- /.product-price -->
                                        <a href="cart.php" class="product__item__btn mediox-btn">
                                            <span>Add to Cart</span>
                                            <span class="mediox-btn__icon"><i class="icon-up-right-arrow"></i></span>
                                        </a><!-- /.mediox-btn -->
                                    </div><!-- /.product-content -->
                                </div><!-- /.product-item -->
                            </div><!-- /.col-xl-4 col-sm-6 -->
                            <div class="col-xl-4 col-sm-6">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'>
                                    <div class="product__item__image">
                                        <img src="assets/images/products/product-1-2.jpg" alt="Accu - Check">
                                    </div><!-- /.product-image -->
                                    <div class="product__item__content">
                                        <div class="mediox-ratings">
                                            <span class="mediox-ratings__icon">
                                        ...
                                        <h4 class="product__item__title"><a href="product-details.php">Accu - Check</a></h4><!-- /.product-title -->
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'>
                                    <div class="product__item__image">
                                        <img src="assets/images/products/product-1-3.jpg" alt="Curesken">
                                    </div><!-- /.product-image -->
                                    <div class="product__item__content">
                                        <div class="mediox-ratings">
                                            <span class="mediox-ratings__icon">
                                        ...
                                        <h4 class="product__item__title"><a href="product-details.php">Curesken</a></h4><!-- /.product-title -->
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                                    <div class="product__item__image">
                                        <img src="assets/images/products/product-1-4.jpg" alt="Supradyn">
                                    </div><!-- /.product-image -->
                                    <div class="product__item__content">
                                        <div class="mediox-ratings">
                                            <span class="mediox-ratings__icon">
                                        ...
                                        <h4 class="product__item__title"><a href="product-details.php">Supradyn</a></h4><!-- /.product-title -->
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'>
                                    <div class="product__item__image">
                                        <img src="assets/images/products/product-1-5.jpg" alt="Ciprofloxacin">
                                    </div><!-- /.product-image -->
                                    <div class="product__item__content">
                                        <div class="mediox-ratings">
                                            <span class="mediox-ratings__icon">
                                        ...
                                        <h4 class="product__item__title"><a href="product-details.php">Ciprofloxacin</a></h4><!-- /.product-title -->
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'>
                                    <div class="product__item__image">
                                        <img src="assets/images/products/product-1-6.jpg" alt="Escitalopram">
                                    </div><!-- /.product-image -->
                                    <div class="product__item__content">
                                        <div class="mediox-ratings">
                                            <span class="mediox-ratings__icon">
                                        ...
                                        <h4 class="product__item__title"><a href="product-details.php">Escitalopram</a></h4><!-- /.product-title -->
        ...
        </section><!-- /.product-page product-page--left section-space-bottom -->
