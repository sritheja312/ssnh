<?php $head_title = "Immediate Care || Mediox || Medical & Healthcare PHP Template" ?>
...
<?php require_once('parts/header/header-four.php'); ?>
                ...
                <div class="page-header__inner">
                    ...
                    <div class="container">
                        <div class="page-header__content">
                            <h2 class="page-header__title">immediate care</h2>
                            <ul class="mediox-breadcrumb list-unstyled">
                                ...
                                <li><span>immediate care</span></li>
                        ...
                        <div class="service-sidebar">
                            <div class="service-sidebar__info service-sidebar__single">
                                <ul class="list-unstyled service-sidebar__nav wow fadeInLeft" data-wow-duration="1500ms">
                                    <li><a href="service-d-immediate-care.php">Immediate Care</a></li>
                                    <li><a href="service-d-dental-care.php">Dental Care</a></li>
                                    <li><a href="service-d-neurology-care.php">Neurology Care</a></li>
                                    <li><a href="service-d-gynaecologists.php">Gynaecologists</a></li>
                                    <li> <a href="service-d-orthopaedics.php">Orthopaedics</a></li>
                                    <li><a href="service-d-cardiology.php">Cardiology</a></li>
                            ...
                            <div class="service-sidebar__single wow fadeInLeft" data-wow-duration="1500ms" data-wow-delay="200ms">
                                <div class="service-sidebar__company">
                                    <a href="contact.php" class="service-sidebar__company__btn">
                                        <i class="icon-download"></i>
                                    </a><!-- /.service-sidebar__company__btn -->
                                    <h4 class="service-sidebar__company__title">company profile</h4><!-- /.service-sidebar__company__title -->
                                </div><!-- /.service-sidebar__company -->
                                <div class="service-sidebar__company">
                                    <a href="contact.php" class="service-sidebar__company__btn">
                                        <i class="icon-download"></i>
                                    </a><!-- /.service-sidebar__company__btn -->
                                    <h4 class="service-sidebar__company__title">company brochure</h4><!-- /.service-sidebar__company__title -->
                                </div><!-- /.service-sidebar__company -->
                        ...
                        <div class="service-details__content">
                            <div class="service-details__inner">
                                <div class="service-details__thumbnail wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                                    <img src="assets/images/services/service-d-1-1.jpg" alt="immediate care">
                                </div><!-- /.service-details__thumbnail -->
                                <div class="service-details__content__box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                                    <h3 class="service-details__title">immediate care</h3><!-- /.service-details__title -->
                                    <p class="service-details__text">There are many
                                        ...
                                        the first true generator on the Internet. It uses a dictionary of over 200 Latin words,</p><!-- /.service-details__text -->
                            ...
                            <div class="service-details__inner-two wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                                <h3 class="service-details__sub-title">Where can I get some?</h3><!-- /.service-details__sub-title -->
                                <p class="service-details__text">Mistaken idea of
                                    ...
                                    how to pursue pleasure rationally encounter consequences that are extremely painful.</p><!-- /.service-details__text -->
                            </div><!-- /.service-details__inner-two -->
                            <div class="service-details__info">
                                <div class="row gutter-y-30">
                                    <div class="col-xl-6 col-lg-12 col-md-6 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                                        ...
                                        </ul><!-- /.list-unstyled team-details__info__list -->
                                    </div><!-- /.col-xl-6 col-lg-12 col-md-6 -->
                                    <div class="col-xl-6 col-lg-12 col-md-6 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="100ms">
                            ...
                            <p class="service-details__text-two wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">Continually
                                myocardinate holistic mindshare with client-based web services. Assertively e-enable catalysts for change before
                                tested markets. Phosfluorescently maintain wireless scenarios after intermandated applications. Conveniently
                                predominate revolutionary quality vectors through future-proof manufactured products. Enthusiastically transform
                                distinctive collaboration.</p><!-- /.service-details__text-two -->
                            <div class="service-details__faq">
                                <h3 class="service-details__faq__title service-details__sub-title">Any questions? We're here to help</h3><!-- /.service-details__sub-title -->
                                        ...
                                        <div class="accordion-content">
                                            <div class="inner">
                                                <p>Bring to the table win-win survival strategies to ensure proactive domination. At the end of
                                                    the day, going forward, a new normal that has evolved from generation X is on the</p>
                                            </div><!-- /.inner -->
        ...
        <section class="services-four section-space-two">
            <div class="container">
                        ...
                        <div class="col-xl-9 col-lg-8">
                            <div class="sec-title @@extraClassName wow fadeInUp" data-wow-duration="1500ms">
                                <div class="sec-title__top">
                                    ...
                                    <img src="assets/images/shapes/sec-title-s-1-1.png" alt="more services" class="sec-title__img">


                                    <h6 class="sec-title__tagline">more services</h6><!-- /.sec-title__tagline -->

                                </div><!-- /.sec-title__top -->
                                <h3 class="sec-title__title">you also like other services</h3><!-- /.sec-title__title -->
                            </div><!-- /.sec-title -->
                        </div><!-- /.col-xl-9 col-lg-8 -->
                        <div class="col-xl-3 col-lg-4">
                            <div class="services-four__custome-navs"></div><!-- /.services-four__cutome-navs -->
                        </div><!-- /.col-xl-3 col-lg-4 -->
                    </div><!-- /.row -->
                </div><!-- /.services-four__top -->
                <div class="services-four__carousel mediox-owl__carousel mediox-owl__carousel--basic-nav owl-carousel owl-theme" data-owl-options='{
                    "items": 1,
                    "margin": 10,
                    "loop": true,
                    "smartSpeed": 700,
                          "navContainer": ".services-four__custome-navs",
                    "nav": true,
                    ...
                    <div class="item wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                        <div class="service-card-three">
                            <div class="service-card-three__image">
                                <img src="assets/images/services/service-4-1.jpg" alt="immediate care">
                            ...
                            <div class="service-card-three__content">
                                ...
                                <h3 class="service-card-three__title">
                                    <a href="service-d-immediate-care.php">immediate care</a>
                                </h3><!-- /.service-card-three__title -->
                                <p class="service-card-three__text">Edical services required on the spot e.g. for medical</p><!-- /.service-card-three__text -->
                    ...
                    <div class="item wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="200ms">
                        <div class="service-card-three">
                            <div class="service-card-three__image">
                                <img src="assets/images/services/service-4-2.jpg" alt="dental care">
                            </div><!-- /.service-card-three__image -->
                            <div class="service-card-three__content">
                                <span class="service-card-three__icon">
                                ...
                                <h3 class="service-card-three__title">
                                    <a href="service-d-dental-care.php">dental care</a>
                                </h3><!-- /.service-card-three__title -->
                                <p class="service-card-three__text">Cross-pollination overcome key issues to meet key</p><!-- /.service-card-three__text -->
                            </div><!-- /.service-card-three__content -->
                        </div><!-- /.service-card-three -->
                    </div><!-- /.item -->
                    <div class="item wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="400ms">
                        <div class="service-card-three">
                            <div class="service-card-three__image">
                                <img src="assets/images/services/service-4-3.jpg" alt="neurology care">
                            </div><!-- /.service-card-three__image -->
                            <div class="service-card-three__content">
                                <span class="service-card-three__icon">
                                ...
                                <h3 class="service-card-three__title">
                                    <a href="service-d-neurology-care.php">neurology care</a>
                                </h3><!-- /.service-card-three__title -->
                                <p class="service-card-three__text">Increase the resolution, scale it up we need a larger print</p><!-- /.service-card-three__text -->
                            </div><!-- /.service-card-three__content -->
                        </div><!-- /.service-card-three -->
                    </div><!-- /.item -->
                    <div class="item wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                        <div class="service-card-three">
                            <div class="service-card-three__image">
                                <img src="assets/images/services/service-4-4.jpg" alt="gynaecologists">
                            </div><!-- /.service-card-three__image -->
                            <div class="service-card-three__content">
                                <span class="service-card-three__icon">
                                    <i class="icon-womb"></i>
                                ...
                                <h3 class="service-card-three__title">
                                    <a href="service-d-gynaecologists.php">gynaecologists</a>
                                </h3><!-- /.service-card-three__title -->
                                <p class="service-card-three__text">Target rich environment form without content style</p><!-- /.service-card-three__text -->
                            </div><!-- /.service-card-three__content -->
                        </div><!-- /.service-card-three -->
                    </div><!-- /.item -->
                    <div class="item wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="200ms">
                        <div class="service-card-three">
                            <div class="service-card-three__image">
                                <img src="assets/images/services/service-4-5.jpg" alt="orthopaedics">
                            </div><!-- /.service-card-three__image -->
                            <div class="service-card-three__content">
                                <span class="service-card-three__icon">
                                    <i class="icon-bone"></i>
                                ...
                                <h3 class="service-card-three__title">
                                    <a href="service-d-orthopaedics.php">orthopaedics</a>
                                </h3><!-- /.service-card-three__title -->
                                <p class="service-card-three__text">Strategic staircase donuts in the break room 4-blocker</p><!-- /.service-card-three__text -->
                            </div><!-- /.service-card-three__content -->
                        </div><!-- /.service-card-three -->
                    </div><!-- /.item -->
                    <div class="item wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="400ms">
                        <div class="service-card-three">
                            <div class="service-card-three__image">
                                <img src="assets/images/services/service-4-6.jpg" alt="cardiology">
                            </div><!-- /.service-card-three__image -->
                            <div class="service-card-three__content">
                                <span class="service-card-three__icon">
                                ...
                                <h3 class="service-card-three__title">
                                    <a href="service-d-cardiology.php">cardiology</a>
                                </h3><!-- /.service-card-three__title -->
                                <p class="service-card-three__text">Draft policy ppml proposal pipeline, for pass the mayo</p><!-- /.service-card-three__text -->
                            </div><!-- /.service-card-three__content -->
                        </div><!-- /.service-card-three -->
                    </div><!-- /.item -->
                </div><!-- /.services-four__carousel -->
            </div><!-- /.container -->
        </section><!-- /.services-four section-space-two -->
