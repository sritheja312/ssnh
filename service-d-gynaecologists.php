<?php $head_title = "Gynaecologists || Mediox || Medical & Healthcare PHP Template" ?>
                ...
                <div class="page-header__inner">
                    ...
                    <div class="container">
                        <div class="page-header__content">
                            <h2 class="page-header__title">gynaecologists</h2>
                            <ul class="mediox-breadcrumb list-unstyled">
                                ...
                                <li><span>gynaecologists</span></li>
                        ...
                        <div class="service-details__content">
                            <div class="service-details__inner">
                                <div class="service-details__thumbnail wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                                    <img src="assets/images/services/service-d-1-4.jpg" alt="gynaecologists">
                                </div><!-- /.service-details__thumbnail -->
                                <div class="service-details__content__box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="00ms">
                                    <h3 class="service-details__title">gynaecologists</h3><!-- /.service-details__title -->
