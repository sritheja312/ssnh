<?php $head_title = "Home Boxed || Mediox || Medical & Healthcare PHP Template" ?>
<?php $body_class="custom-cursor  boxed-wrapper"?>
<?php
  $home = true;
?>
<!-- Header Here -->
...
require_once('parts/home1/funfact.php');
require_once('parts/home1/appointment.php');
